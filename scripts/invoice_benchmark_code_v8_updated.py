...
# === Step 3: Build CPT Code List per Invoice ===
cpt_list_df = (
...
# === Step 4.5: Add Row-Level Metrics ===
...
# === Step 5.5: Row-Level Variance from Benchmark ===
...
# === Step 6: Invoice-Level Aggregates ===
invoice_sums = (
    df_inv
...
# === Step 6.5: Merge Invoice Aggregates Back ===
df_inv = df_inv.merge(invoice_sums, on=["Invoice_Number", "Benchmark_Key"], how="left")

# === Step 7: Invoice-Level Benchmark Aggregates ===
...
# === Step 8: Eliminate Duplicate Columns ===
df_inv = df_inv.loc[:, ~df_inv.columns.duplicated(keep="first")]

# === Step 9: Export Final CSV and ZIP ===
